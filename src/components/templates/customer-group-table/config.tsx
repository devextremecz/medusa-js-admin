...
export const CUSTOMER_GROUPS_TABLE_COLUMNS: Array<Column<CustomerGroup>> = [
  {
    Header: () => (
...
export const CUSTOMER_GROUPS_CUSTOMERS_TABLE_COLUMNS: Array<Column<Customer>> = [
  {
    id: 'selection',
...
export const CUSTOMER_GROUPS_CUSTOMERS_LIST_TABLE_COLUMNS: Array<Column<Customer>> = [
  {
    Header: () => (
      <div className="flex items-center gap-1">
        Name <SortingIcon size={16} />
