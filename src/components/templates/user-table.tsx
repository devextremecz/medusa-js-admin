  ...
  const filteringOptions = [
    {
      ...
      options: [
        ...
        {
          title: 'Member',
          count: elements.filter((e) => e.entityType === 'user' && e.entity.role === 'member')
            .length,
          onClick: () =>
            setShownElements(
              elements.filter((e) => e.entityType === 'user' && e.entity.role === 'member')
            ),
        },
        {
          title: 'Admin',
          count: elements.filter((e) => e.entityType === 'user' && e.entity.role === 'admin')
            .length,
          onClick: () =>
            setShownElements(
              elements.filter((e) => e.entityType === 'user' && e.entity.role === 'admin')
            ),
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          count: elements.filter(
            (e) => e.entityType === 'invite' && getInviteStatus(e.entity) === 'pending'
          ).length,
          onClick: () =>
            setShownElements(
              elements.filter(
        ...
        },
        {
          title: 'Expired',
          count: elements.filter(
            (e) => e.entityType === 'invite' && getInviteStatus(e.entity) === 'expired'
          ).length,
          onClick: () =>
            setShownElements(
              elements.filter(
