...
const AnalyticsPreferencesModal = () => {
  ...
  const onSubmit = form.handleSubmit((data) => {
    ...
    mutate(config, {
      onSuccess: () => {
        notification('Success', 'Your preferences were successfully updated', 'success');
      ...
      <FocusModal.Main>
        <div className="flex flex-col items-center">
          <div className="mt-5xlarge flex flex-col max-w-[664px] w-full">
            <h1 className="inter-xlarge-semibold mb-large">Help us get better</h1>
            <p className="text-grey-50">
              To create the most compelling e-commerce experience we would like to gain insights in
              how you use Medusa. User insights allow us to build a better, more engaging, and more
              usable products. We only collect data for product improvements. Read what data we
              gather in our{' '}
              <a
