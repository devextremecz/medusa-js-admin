  ...
  return (
    <div className="flex flex-col gap-y-xlarge">
      ...
      >
        <div className="flex flex-col flex-1 gap-y-2xsmall">
          ...
          <p className="inter-base-regular text-grey-50">
            You can choose to anonymize your usage data. If this option is selected, we will not
            collect your personal information, such as your name and email address.
          </p>
        </div>
        <Controller
          name={path('anonymize')}
      ...
      <div className="flex items-start">
        <div className="flex flex-col flex-1 gap-y-2xsmall">
          <h2 className="inter-base-semibold">Opt out of sharing my usage data</h2>
          <p className="inter-base-regular text-grey-50">
