...
export const formValuesToCreateDiscountMapper = (
  ...
  return {
    ...
    rule: {
      allocation:
        values.rule.type === DiscountRuleType.FIXED ? values.rule.allocation : AllocationType.TOTAL,
    ...
    valid_duration:
      values.is_dynamic && values.valid_duration?.length ? values.valid_duration : undefined,
  };
};
