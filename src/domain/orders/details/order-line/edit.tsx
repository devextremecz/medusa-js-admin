        ...
        <div className="flex space-x-4 justify-center flex-grow-1">
          ...
          <div className="flex flex-col justify-center">
            <div className="flex gap-2 items-center max-w-[310px]">
              <span
                className={clsx('font-semibold text-grey-900 flex-shrink-0 flex-grow', {
              ...
              {item?.variant?.options && (
                <span
                  className={clsx('text-gray-400 flex gap-3 flex-shrink-1 truncate', {
                    'text-gray-400': isLocked,
                  })}
                >
          ...
          <div className="flex gap-6 items-center h-full">
            ...
            >
              ...
              >
                ...
                <span className="text-gray-400 ml-2">{currencyCode.toUpperCase()}</span>
              </div>
            </div>
