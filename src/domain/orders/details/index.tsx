      ...
      <OrderEditProvider orderId={id!}>
        ...
        {isLoading || !order ? (
          ...
          <>
              ...
              <div className="flex h-full w-7/12 flex-col">
                ...
                >
                  <div className="mt-6 flex space-x-6 divide-x">
                    <div className="flex flex-col">
                      <div className="inter-smaller-regular mb-1 text-grey-50">Email</div>
                      <button
                    ...
                    <div className="flex flex-col pl-6">
                      <div className="inter-smaller-regular mb-1 text-grey-50">Payment</div>
                ...
                >
                  <div className="mt-6">
                    ...
                    <div className="mt-6 flex space-x-6 divide-x">
                      <div className="flex flex-col">
                        <div className="inter-small-regular mb-1 text-grey-50">Contact</div>
            ...
            {showRefund && (
              <CreateRefundModal order={order} onDismiss={() => setShowRefund(false)} />
            )}
