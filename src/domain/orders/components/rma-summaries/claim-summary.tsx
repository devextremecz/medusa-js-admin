        ...
        {claimType !== 'refund' && replacementItems.length > 0 && (
          <div>
            <div className="mb-small flex items-center gap-x-2xsmall">
              ...
              <IconTooltip
                type="warning"
                content="The customer will receive a full refund for the claimed items, as the cost of replacement items and shipping will not be deducted. Alternatively, you can choose to set a custom refund amount when you receive the returned items or create an exchange instead."
              />
            </div>
            <div className="flex flex-col gap-y-xsmall">
