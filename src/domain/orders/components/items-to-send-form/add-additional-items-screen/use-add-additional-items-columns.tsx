  ...
  return useMemo(
    () => [
      columnHelper.display({
        ...
        cell: ({
          row: { getIsSelected, getIsSomeSelected, getToggleSelectedHandler, getCanSelect },
        }) => {
          ...
          return (
            <div className="pl-base pr-large">
              {canSelect ? (
                ...
                <Tooltip content="This variant does not have a price for the region/currency of this order, and cannot be selected.">
                  <IndeterminateCheckbox
                    checked={getIsSelected()}
                    indeterminate={getIsSomeSelected()}
                    onChange={getToggleSelectedHandler()}
