...
describe('ShippingForm return shipping', () => {
  ...
  beforeEach(() => {
    ...
    renderWithProviders(
      <div>
        <ShippingForm order={order} isClaim isReturn form={nestedForm(form, 'return_shipping')} />
      </div>
    );
  });
  ...
  it('should render correctly when option is selected', async () => {
    const shippingOption = fixtures.get('shipping_option') as unknown as ShippingOption;
...
describe('ShippingForm return shipping', () => {
  ...
  beforeEach(() => {
    ...
    renderWithProviders(
      <div>
        <ShippingForm order={order} isClaim form={nestedForm(form, 'replacement_shipping')} />
      </div>
    );
  });
