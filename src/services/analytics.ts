...
export const useAdminUpdateAnalyticsConfig = () => {
  ...
  return useMutation((payload: UpdateConfigPayload) => updateAnalyticsConfig(payload), {
...
export const useAdminCreateAnalyticsConfig = () => {
  ...
  return useMutation((payload: CreateConfigPayload) => createAnalyticsConfig(payload), {
    onSuccess: invalidateAnalyticsConfig,
  });
};
